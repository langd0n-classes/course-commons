...
def main() -> None:
    ...
    default_logo = ""
    candidate_logo = Path("grading/incompletes/boston-univ.gif")
    if candidate_logo.exists():
        default_logo = str(candidate_logo)
    logo_path = args.logo or prompt("Logo path (optional)", default_logo)
